window.onload = function () {
  ...
  var timer = 0;
  var afterImages = [];
  var afterImageTones = ["rgba(232, 223, 214, " + 0.8 + ")", "rgba(232, 223, 214, " + 0.6 + ")", "rgba(232, 223, 214, " + 0.4 + ")", "rgba(232, 223, 214, " + 0.2 + ")", "rgba(232, 223, 214, " + 0.1 + ")"].reverse();
  ...
  space.add({
    animate: function (time, fps, ctx) {
      ...
      form.stroke(beatDropped() ? "#e8dfd6" : "#3b1415", audioElement.currentTime > 21.3 ? 2 : 1);
